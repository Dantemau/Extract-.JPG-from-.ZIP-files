...
folder = ('C:/Users/KDanielADLAP/Downloads/Recursos Audiovisuales/Plantillas para diseños/Pumpkin')
            ...
            with zipfile.ZipFile(os.path.join(folder,zip_file)) as zf:
                ...
                for zip_info in zf.infolist():
                    ...
                    if extensions_re.search(zip_info.filename):
                        ...
                        zf.extract(zip_info, os.path.join(folder, zip_file.replace('.zip','')))
